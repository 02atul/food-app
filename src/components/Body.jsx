...
const Body = () => {
    ...
    let [resList,setResList] = useState([
        {
          ...
          "analytics": {
            "context": "seo-data-6de6391e-5f4c-45d6-930a-e2c3d7a248de"
          },
          "cta": {
        ...
        },
        {
          "info": {
            ...
            "availability": {
              "nextCloseTime": "2024-07-09 20:45:00",
              "opened": true
            },
            "badges": {
              "imageBadges": [
        ...
        },
        {
          ...
          "cta": {
            "link": "https://www.swiggy.com/restaurants/new-agrawal-sweets-sapna-sangeeta-road-indore-104277",
            "text": "RESTAURANT_MENU",
            "type": "WEBLINK"
          },
          "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
        },
        {
          "info": {
            ...
            "cloudinaryImageId": "eogrde92rpsnrk7bkpnt",
            "locality": "Ravi Shankar Shukla Nagar",
            "areaName": "HIG    LIG",
          ...
          "cta": {
            "link": "https://www.swiggy.com/restaurants/jmb-jain-mithai-bhandar-ravi-shankar-shukla-nagar-hig-lig-indore-500106",
            "text": "RESTAURANT_MENU",
            "type": "WEBLINK"
          },
          "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
        },
        {
          ...
          "cta": {
            "link": "https://www.swiggy.com/restaurants/cafe-udipi-old-palasia-indore-64555",
            "text": "RESTAURANT_MENU",
            "type": "WEBLINK"
          },
          "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
        ...
        },
        {
          "info": {
            ...
            "availability": {
              "nextCloseTime": "2024-07-09 23:45:00",
              "opened": true
            },
            "badges": {},
            "isOpen": true,
    ...
    let [logButton,setLogButton] = useState("logout")
    useEffect( () => { fetchData();},[]);
            ...
            onClick={
                () => {
                    ...
                    let filteredList = resList.filter(
                        (res) => res.info.includes(searchText)
